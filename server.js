...
const COMPANY_NAME = process.env.COMPANY_NAME || 'Nexus AI Consultoria';
const COMPANY_POSITIONING = process.env.COMPANY_POSITIONING || 'Consultoria especializada em IA, BI e Dashboards Power BI';
const COMPANY_BUSINESS_MODEL = process.env.COMPANY_BUSINESS_MODEL || 'Consultoria B2B de alto valor, contratos recorrentes e projetos de transformacao orientada a dados';
const COMPANY_IDEAL_CLIENT = process.env.COMPANY_IDEAL_CLIENT || 'PMEs e empresas em crescimento que precisam escalar decisao com IA, BI e automacao';
const COMPANY_STYLE = process.env.COMPANY_STYLE || 'Tom executivo, consultivo, orientado a ROI, com linguagem moderna e tech';
